       ...
       :
        <>
          {searchCardList && searchCardList.length ?
            <PrelemSearchCard searchCardList={searchCardList} />
           :
            <EmptyState
