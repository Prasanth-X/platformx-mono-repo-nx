      ...
      {categoriesdata?.tags?.length > 0 ?
        ...
        >
          ...
          >
            {[...categoriesdata?.tags || []]
              .sort()
              ?.slice(0, count)?.map((tag, index1) => {
                return (
                  <ListItem
                    disabled={selectedTags.includes('Courses') && tag != 'Courses' || selectedTags.includes('Community') && tag != 'Community' ? true : false}
                    key={index1}
                    sx={{
                      display: 'inline-flex',
                      width: 'auto',
                  ...
                  >
                    <FormControlLabel
                      ...
                      onChange={(e) => {
                        if (selectedTags.includes('Courses') && tag != 'Courses' || selectedTags.includes('Community') && tag != 'Community') {
                          return;
                        } else {
                          updateTagField(e);
                        }
