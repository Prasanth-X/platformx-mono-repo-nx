...
import { getSelectedSite, getSubDomain } from '../../../utils/helperFunctions';
import { fetchSites } from '../../../services/SiteCreation/SiteCreation.api';
...
const CreateUser = () => {
  ...
  const editUserDetails = async (url) => {
    const {
      timezone,
      image,
      phone,
