...
const Poll = ({
  ...
  const embedPageURL = publishUrl + language + "/embed/poll" + content?.current_page_url;
  const landingPageURL = publishUrl + language + "/poll" + content?.current_page_url;
  const embedData = {
    Title: content?.title,
  ...
  const onStaticSubmit = () => {
    if (results.length > 0 && Object.keys(pollData).length !== 0) {
      const tempOptions = pollData.options.map((option: any) => {
        const currentOpt = results.find((x: any) => x.option_id === option.option_id);
        return {
          ...option,
...
Poll.defaultProps = {
  content: {
    ...
    question_background_content: {
      ...
      Color: "",
      original_image: {
        original_image_relative_path: "1691408200703/public/jpeg/broadband-commission-hero",
      ...
      published_images: [
        {
          aspect_ratio: "portrait",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-portrait",
        },
        {
          aspect_ratio: "card1",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-card1",
        },
        {
          aspect_ratio: "landscape",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-landscape",
        },
        {
          aspect_ratio: "hero",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-hero",
        },
        {
          aspect_ratio: "card2",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-card2",
        },
        {
          aspect_ratio: "square",
          folder_path: "1691408200703/public/jpeg/broadband-commission-hero-square",
        },
      ],
    },
    background_content: {
    ...
    original_image: {
      original_image_relative_path: "1691425177739/public/jpeg/biome-ssa-1440x620",
