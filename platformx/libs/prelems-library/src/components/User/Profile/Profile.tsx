      ...
      if (errorMsgCheck) {
        ...
        if (isSuccess) {
          ...
          ToastService.failToast(
            errors.length > 0 ? errors[0]?.message : t(errorRequest)
          );
    ...
    if (userId) {
      ...
      if (status === 200 && Object.keys(nullToObject(viewProfile)).length > 0) {
        const newObj = {
          ...
          timezone:
            viewProfile?.timezone || 'Asia/Calcutta 22:27:58 GMT+0530 (IST)',
              ...
              <Box className="leftSideBar">
                {menuArr?.map((item: any, index: number) => (
                  <Typography
                    ...
                    variant="p3regular"
                    className={
                      activeMenu === index ? 'menuItem activeItem' : 'menuItem'
                    }
                          ...
                          <Box className="gridContentWrapper">
                            <Box className="mobileWithIsdcode">
                              ...
                              <StringOnBlurTextBox
                                ...
                                errorMessage={
                                  stateErrorManage.mobileNumberError
                                }
                                isCloseIcon={!isDisabled}
                              />
                            </Box>
                              ...
                              <DatePicker
                                ...
                                renderInput={(params) => (
                                  <TextField
                                    ...
                                    value={
                                      params.value
                                        ? dayjs(params.value as Date).format(
                                            'DD/MM/YYYY'
                                          )
                                        : ''
                                    }
