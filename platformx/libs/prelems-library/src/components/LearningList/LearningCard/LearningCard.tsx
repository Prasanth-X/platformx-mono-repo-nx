...
const LearningCard = ({ viewCourse, item }: any) => {
  ...
  return (
    <Container className={`${classes.learningCardWrapper} grid_container learningCard`}>
          ...
          <Grid xs={12} md={8} lg={9}>
            <Box className='RightContentWrapper'>
              <Box className='topWrapper'>
                ...
                <Typography variant='p4regular' className='learningCardDescription'>
                ...
                <Box className='botLeftWp'>
                  ...
                  <ul>
                    <li>
                      ...
                      <Typography variant='p4semibold'>{item?.teaser}</Typography>
                    </li>
                  </ul>
                </Box>
                <Box className='botRightWp'>
                  <Button variant='primaryButton2' className='sm' onClick={() => viewCourse(item)}>
                    View Course
                  </Button>
                </Box>
              </Box>
