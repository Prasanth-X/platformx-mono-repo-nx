      ...
      <Container className='grid_container'>
        <Grid container>
          <Grid xs={12} md={8} sx={{ paddingRight: { xs: 0, md: "45px" } }}>
            ...
            <Typography variant='p3regular'>{handleHtmlTags(content?.title)}</Typography>
            <Typography variant='labelregular' sx={{ textTransform: "capitalize" }}>
              Created by{" "}
            ...
            <Box>
              <Box className='bottomBlackWrapper'>
                <ul>
                  <li>
                    <LanguageIcon />
                    <Typography variant='labelregular'>{content?.mainlanguage}</Typography>
                  </li>
                  <li>
                    <AccessTimeIcon />
                    <Typography variant='labelregular'>
                      ...
                      {content?.mainlanguage &&
                        format(new Date(content?.published_date), "LLL dd, yyyy")}
                    </Typography>
                  </li>
                </ul>
              </Box>
