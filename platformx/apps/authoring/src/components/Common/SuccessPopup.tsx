      ...
      <>
        <div className="deletePopupContaniner">
            ...
            >
                ...
                <Box sx={{ textAlign: 'center', color: '#fd0c0d', margin: {xs: 0, md: '71px 0 4px'} }}>
                    <Box sx={{ width: { xs: '90px', md: '100px'}, height: { xs: '90px', md: '100px'}, margin: 'auto !important' }}>
