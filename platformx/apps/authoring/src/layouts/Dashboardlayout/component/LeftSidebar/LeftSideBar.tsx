...
export default function LeftSideBar({ open, handleDrawerOpen, handleMenuAction, className }) {
      ...
      <Drawer variant='permanent' open={open}>
        <Box className='mainBox'>
          <Box>
            ...
            <MenuList open={open} handleMenuclose={handleDrawerOpen} handleMenuAction={handleMenuAction}/>
          </Box>
          <Box className='auth'>
            <MiniHeader />
          </Box>
