const ThemeConstants = {
  ...
  PRIMARY_PRELEM: {
    ...
    BUTTON: {
      VARIANT1: {
        COLOR: "#FFFFFF",
        COLOR_HOVER: "#FFFFFF",
        BACKGROUND_COLOR: "#008A8E",
        BACKGROUND_COLOR_HOVER: "#006568",
        BORDER: "solid 1px  #008A8E",
        BORDER_HOVER: "solid 1px  #008A8E",
      },
      VARIANT2: {
        COLOR: "#008A8E",
        COLOR_HOVER: "#FFFFFF",
  ...
  TERTIARY_PRELEM: {
    ...
    TAB: {
      VARIANT1: {
        TITLE: "#14142B",
        TITLE_ACTIVE: "#FFF",
        TITLE_BACKGROUND: "#EAF5F6",
        TITLE_ACTIVE_BACKGROUND: "#008A8E",
        PARAGRAPH: "#4E4B66",
        LABEL: "#6E7191",
        LINE: "#D9DBE9",
        BACKGROUND_COLOR: "#EAF5F6",
        BACKGROUND_COLOR_ACTIVE: "#EAF5F6",
        BORDER_COLOR: "#D9DBE9",
        BORDER_COLOR_ACTIVE: "#14142B",
      },
    },
  ...
  FOOTER: {
    VARIANT1: {
      BACKGROUND: "#0B0B0B",
      BACKGROUND_SECOND: "linear-gradient(to bottom, #424244 1px, #000 1px, #000 100%)",
      TITLE: "#FFFFFF",
      TITLE_HOVER: "#FFFFFF",
      PARAGRAPH: "#FFFFFF",
      PARAGRAPH_HOVER: "#FFFFFF",
