...
import { completeButtonUrl, createIconUrl, assetsPng, formCroppedUrl } from "@platformx/utilities";
    ...
    return (
      <Box className='imageWrapper widthheight100'>
        ...
        <Box className='imageWrapper1'>
          <img
            alt='About us'
            src={createIconUrl(secondaryArgs, assetsPng.frame1)}
            className='frame1'
            width='200'
            height='87'
          />
        ...
        <Box className='imageWrapper2'>
          <img
            alt='About us'
            src={createIconUrl(secondaryArgs, assetsPng.frame2)}
            className='frame2'
            width='170'
            height='72'
          />
        ...
        <Box className='imageWrapper3'>
          <img
            alt='About us'
            src={createIconUrl(secondaryArgs, assetsPng.frame3)}
            className='frame3'
            width='232'
            height='40'
          />
