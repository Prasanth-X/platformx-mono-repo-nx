...
const ShippingDetails = ({
  ...
  const errorMsgUpdate = () => {
    return {
      ...stateErrorManage,
      addressError: stateManage.address
        ? ''
        : `${t('address')} ${t('is_mandatory')}`,
      firstNameError: stateManage.firstName
        ? ''
        ...
        <Grid container>
          ...
          <Grid item xs={12} sm={12} md={12} em={7} lg={8} xl={8}>
            {!preViewAddressToggle ? (
              ...
              <>
                <Box
                  className={`shipping-address-wrapper-left address-section rightGap1`}
                >
                  <AddessPreview
                    stateManage={stateManage}
                    preViewAddress={preViewAddress}
                  ...
                  <OrderNotes />
                  <Box
                    className="bottom-button-text-wrapper textWrapper"
                    mb={1}
                  >
                    <Button
                      type="button"
