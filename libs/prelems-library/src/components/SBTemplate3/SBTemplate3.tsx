...
import { useCustomStyle } from "./SBTemplate3.style";
...
SBTemplate3Prop) => {
  ...
  const defaultStructureData = () => {
    ...
    return SBTemplate3StructureData;
  };
  ...
  const generateStructureData = () => {
    ...
    if (firstRender.current === true) {
      ...
      if (String(tempSD).length > 0) {
        SBTemplate3StructureData = JSON.parse(tempSD);
      } else {
        SBTemplate3StructureData = defaultStructureData();
      }
...
SBTemplate3.defaultProps = {
  content: {
    Button1_Action: "External",
    Button1_Content:
      '{"pagination":{"start":0,"rows":10},"searchTerm":"","tags":[],"filter":"SBTemplate3","isSuggestive":false,"SBTemplate3":{"filter":[]}}',
