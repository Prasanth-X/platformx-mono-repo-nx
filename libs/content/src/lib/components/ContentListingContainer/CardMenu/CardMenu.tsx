...
import { CARD_MENUS } from './constants';
    ...
    <>
      ...
      >
        ...
        >
          {status === 'published' ? (
            <>
              <img src={CardOptionViewIcon} className={classes.icon} />
              {t('view')}
            </>
          ) : (
            <>
              <img src={CardOptionViewIcon}
        ...
        <ErrorTooltip
          component={
            ...
            >
              <img src={CardOptionDuplicateIcon}
                className={classes.icon}
              />
        ...
        {status === 'published' &&
          ...
          <ErrorTooltip
            component={
              ...
              >
                <img src={CardOptionUnPublishIcon}
                  className={classes.icon}
                />
        ...
        >
          <img src={CardOptionApprovalStatusIcon}
            className={classes.icon}
          />
          {t('approval_status')}
        </MenuItem>
